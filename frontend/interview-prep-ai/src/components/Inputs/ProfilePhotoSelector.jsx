  ...
  return <div className='flex justify-center mb-6'>
    ...
    {!image ? (
        ...
        <div className='relative '>
            ...
            <button
            type='button'
            className='w-8 h-8 flex items-center justify-center bg-red-500 from-orange-500/85 to-orange-600 text-white rounded-full absolute -bottom-1 -right-1 cursor-pointer '
